...
### In this tutorial we use clojure and machine learning to generate pieces of art/pictures. 
## Run `lein deps` to install the dependencies, then run `lein run` to run the app. 

### Check out the Youtube Tutorial for this [Clojure Program](https://youtu.be/u7qg-anw2io). Here is our [Youtube Channel](https://www.youtube.com/channel/UCYqCZOwHbnPwyjawKfE21wg) Subscribe for more content.
